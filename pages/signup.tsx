...
function Signup() {
  ...
  return (
    <form className='max-w-md max-mobile:max-w-[95%] m-auto h-max absolute top-0 bottom-0 left-0 right-0 bg-white rounded-lg shadow-1' onSubmit={handleSubmit}>
      ...
      <section className='px-4 mt-2'>
        <button type='submit' className='mt-2 bg-black hover:bg-slate-800 w-full py-[6px] text-lg rounded-md text-white font-medium'>Sign Up</button>
